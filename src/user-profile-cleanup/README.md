...
This module scans and cleans temporary and cache data in the current Windows user profile.

## Script

- `user-profile-cleanup-v2.ps1`
...
```powershell
pwsh -File .\src\user-profile-cleanup\user-profile-cleanup-v2.ps1
```
