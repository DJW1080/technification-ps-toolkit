...
![Version 1.0](https://img.shields.io/badge/Version-1.2-yellow?logo=version "Version 1.2")  

This module provides Windows repair and maintenance actions through a submenu inside Technification Toolbox.
...
- Resets parts of the network stack
...
Session and action logs are written under:

```text
%LOCALAPPDATA%\Win-Auto-Repair
```

## Run Directly

```powershell
pwsh -File .\src\windows-auto-repair\win-auto-repair-v1.ps1
```
